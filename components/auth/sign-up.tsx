...
interface SignUpProps {
  ...
  handleOAuthSignUp: (provider: "github") => void;
        ...
        <div className="max-w-md mx-auto w-full p-4">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-primary/10 px-4 text-muted-foreground">
                or
              </span>
            </div>
          </div>
          <form className="mt-4 space-y-4 w-full" onSubmit={handleEmailSignUp}>
